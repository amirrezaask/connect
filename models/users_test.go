...
func testUserToManyChannels(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	_, err = tx.Exec("insert into \"channel_users\" (\"user_id\", \"channel_id\") values ($1, $2)", a.ID, b.ID)
	if err != nil {
		t.Fatal(err)
	}
	_, err = tx.Exec("insert into \"channel_users\" (\"user_id\", \"channel_id\") values ($1, $2)", a.ID, c.ID)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadChannels(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testUserToManyHubPermissions(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := UserSlice{&a}
	if err = a.L.LoadHubPermissions(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testUserToManyHubs(t *testing.T) {
	...
	_, err = tx.Exec("insert into \"hub_users\" (\"user_id\", \"hub_id\") values ($1, $2)", a.ID, b.ID)
	if err != nil {
		t.Fatal(err)
	}
	_, err = tx.Exec("insert into \"hub_users\" (\"user_id\", \"hub_id\") values ($1, $2)", a.ID, c.ID)
	if err != nil {
		t.Fatal(err)
	}
...
func testUserToManyCreatorHubs(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	check, err := a.CreatorHubs().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadCreatorHubs(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.CreatorHubs); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.CreatorHubs = nil
	if err = a.L.LoadCreatorHubs(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.CreatorHubs); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyAddOpChannels(t *testing.T) {
	var err error
...
func testUserToManySetOpChannels(t *testing.T) {
	var err error
...
func testUserToManyRemoveOpChannels(t *testing.T) {
	var err error
...
func testUserToManyAddOpHubPermissions(t *testing.T) {
	var err error
...
func testUserToManySetOpHubs(t *testing.T) {
	var err error
	...
	err = a.SetHubs(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
...
func testUserToManyRemoveOpHubs(t *testing.T) {
	var err error
	...
	err = a.AddHubs(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemoveHubs(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
...
func testUserToManyAddOpCreatorHubs(t *testing.T) {
	var err error
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddCreatorHubs(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.CreatorHubs[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.CreatorHubs[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.CreatorHubs().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testUserToManySetOpCreatorHubs(t *testing.T) {
	var err error
	...
	err = a.SetCreatorHubs(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetCreatorHubs(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
	...
	if b.R.CreatorUser != nil {
		t.Error("relationship was not removed properly from the foreign struct")
	}
	if c.R.CreatorUser != nil {
		t.Error("relationship was not removed properly from the foreign struct")
	}
	if d.R.CreatorUser != &a {
		t.Error("relationship was not added properly to the foreign struct")
	}
	if e.R.CreatorUser != &a {
		t.Error("relationship was not added properly to the foreign struct")
	}

	if a.R.CreatorHubs[0] != &d {
		t.Error("relationship struct slice not set to correct value")
	}
	if a.R.CreatorHubs[1] != &e {
		t.Error("relationship struct slice not set to correct value")
	}
}

func testUserToManyRemoveOpCreatorHubs(t *testing.T) {
	var err error
	...
	err = a.AddCreatorHubs(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemoveCreatorHubs(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
	...
	if len(a.R.CreatorHubs) != 2 {
		t.Error("should have preserved two relationships")
	}

	// Removal doesn't do a stable deletion for performance so we have to flip the order
	if a.R.CreatorHubs[1] != &d {
		t.Error("relationship to d should have been preserved")
	}
	if a.R.CreatorHubs[0] != &e {
		t.Error("relationship to e should have been preserved")
	}
}
...
func testUserToManySetOpMessages(t *testing.T) {
	var err error
...
func testUserToManyRemoveOpMessages(t *testing.T) {
	var err error
...
var (
	userDBTypes = map[string]string{`ID`: `character varying`, `Username`: `character varying`, `Email`: `character varying`, `PasswordHash`: `character varying`}
	_           = bytes.MinRead
)
